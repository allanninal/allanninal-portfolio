...
SPECS = [
    ...
    dict(file="og-climatespread.png", icon="&#127777;&#65039;", pill="Global &middot; Climate",
         ...
         sub="Seven CMIP6 models, sixteen cities, 1991&ndash;2010 against 2031&ndash;2050",
         stats=[("16 of 16", "Cities warmed by every model"), ("0.51&deg;C", "Median model disagreement"), ("0.03&ndash;1.57", "Delhi, across models")]),
]
